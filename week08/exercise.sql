...
CREATE OR REPLACE TABLE TRAINING_DB.WEEK08.DIM_MATERIAL (
    MATERIAL_KEY          INT AUTOINCREMENT PRIMARY KEY,
...
CREATE OR REPLACE TABLE TRAINING_DB.WEEK08.DIM_BATCH (
    BATCH_KEY             INT AUTOINCREMENT PRIMARY KEY,
...
CREATE OR REPLACE TABLE TRAINING_DB.WEEK08.FACT_MATERIAL_COST (
    MATERIAL_COST_KEY     INT AUTOINCREMENT PRIMARY KEY,
    DATE_ID               INT          NOT NULL REFERENCES TRAINING_DB.WEEK08.DIM_DATE(DATE_ID),
    PRODUCT_KEY           INT          NOT NULL REFERENCES TRAINING_DB.WEEK08.DIM_PRODUCT(PRODUCT_KEY),
    MATERIAL_KEY          INT          NOT NULL REFERENCES TRAINING_DB.WEEK08.DIM_MATERIAL(MATERIAL_KEY),
    BATCH_KEY             INT          NOT NULL REFERENCES TRAINING_DB.WEEK08.DIM_BATCH(BATCH_KEY),
